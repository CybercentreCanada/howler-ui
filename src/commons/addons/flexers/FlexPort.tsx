...
const FlexPort = ({ children, disableOverflow = false, ...props }: FlexPortProps) => {
  ...
  return (
    ...
    >
      <div style={{ position: 'absolute', top: 0, right: 0, bottom: 0, left: 0, overflow: !disableOverflow && 'auto' }}>
        {children}
      </div>
    </div>
  );
